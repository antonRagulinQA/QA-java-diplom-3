...
import static handlers.WebDriverSettings.getWebDriver;
...
public class AuthTests {
    ...
    public void startUp() {
        ...
        webDriver.get(Paths.URL_MAIN_PAGE);
    ...
    public void authLinkFromRegFormIsSuccess() {
        ...
        webDriver.get(Paths.URL_REGISTER_PAGE);
    ...
    public void authLinkFromForgotPasswordFormIsSuccess() {
        ...
        webDriver.get(Paths.URL_FORGOT_PASSWORD_PAGE);
